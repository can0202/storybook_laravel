            ...
            <div class="card-body">
               ...
               <form method="POST" action="{{route('category.update', [$category->id])}}">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" value="{{ $category->title }}" onkeyup="ChangeToSlug()" name="title" class="form-control" id="slug">
                  </div>
                  <div class="form-group">
                     <label>Slug</label>
                     <input type="text" value="{{ $category->slug }}" name="slug" class="form-control" id="convert_slug">
                  </div>
                  <div class="form-group">
