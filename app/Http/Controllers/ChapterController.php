...
class ChapterController extends Controller
{
    ...
    {
        $list_chapter = Chapter::orderBy('id', 'DESC')->paginate(5);
    ...
    public function edit($id)
    {
        ...
        return view('adminCP.chapters.edit')->with(compact('chapter', 'story'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $chapter->save();
        return redirect()->back()->with('status', 'Update chapter successful!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('status', 'Delete chapter successful!');
    }
}
