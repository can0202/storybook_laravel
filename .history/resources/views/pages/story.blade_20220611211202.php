         ...
         <div class="story-info">
            <div class="row">
               ...
               <div class="col-sm-8">
                  ...
                  <ul>
                     ...
                     <li><i class="ion-wifi"></i> Status: <span class="text text-">{{$story->status}}</span></li>
                     <li><i class="ion-pricetag"></i> Type: <a href="#">{{$story->category_id->title}}</a></li>
            ...
            <div class="story-desc">
               ...
               <ul class="list-content">
                  <li><a href="#"><i class="ion-ios-arrow-right"></i> Chương 1</a></li>
                  <li><a href="#"><i class="ion-ios-arrow-right"></i> Chương 1</a></li>
                  <li><a href="#"><i class="ion-ios-arrow-right"></i> Chương 1</a></li>
                  <li><a href="#"><i class="ion-ios-arrow-right"></i> Chương 1</a></li>
                  <li><a href="#"><i class="ion-ios-arrow-right"></i> Chương 1</a></li>
