      ...
      <div class="col-sm-12">
         <div class="content-single">
            ...
            <div class="chapter-btn">
               <a href="" class="btn btn-primary"><i class="ion-ios-arrow-thin-left"></i> Prev chapter</a>
               <select name="" id="select_chapter">
                  @foreach($all_chapter as $key => $value)
                  <option value="{{url('xem-chapter/'.$value->slug)}}">{{$value->title}}</option>
                  @endforeach
               </select>
               <a href="" class="btn btn-primary">Next chapter <i class="ion-ios-arrow-thin-right"></i></a>
            </div>
            <article>
               {!! $chapter->content !!}
            </article>
