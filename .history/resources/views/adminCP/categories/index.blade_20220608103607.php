                     ...
                     <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                        ...
                        <tbody>
                           ...
                           <tr class="odd">
                              ...
                              <td>
                                 <a href="{{ route('category.edit', ['category' => $value->id]) }}" class="btn btn-primary btn-icon-split btn-sm">Edit</a>
                                 <form action="{{ route('category.destroy', ['category'=>$value->id]) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button onclick="return confirm('Are You Sure?')" class="text text-danger">Delete</button>
                                 </form>
                              </td>
                           </tr>
                           @endforeach
