               ...
               <div class="col-lg-5 text-right">
                  <div class="head-social">
                     <ul>
                        ...
                        <li class="main-switch-icon">
                           <div class="theme-switch-wrapper" title="Theme Mode">
                              <label class="theme-switch" for="checkbox">
                                 <input type="checkbox" id="checkbox">
                                 <div class="slider-switch round">
                                    <i class="ion-ios-sunny dark_theme"></i>
                                    <i class="ion-ios-moon-outline moon_theme"></i>
                                 </div>
                              </label>
                           </div>
                        </li>
                        <li class="dark-mode">
                           <i class="ion-ios-moon-outline" id="moon"></i>
                           <i class="ion-ios-sunny-outline" id="sunny"></i>
                        </li>
                     </ul>
                  </div>
               </div>
